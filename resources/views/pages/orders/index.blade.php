                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" class="symbol symbol-50px">
                                    <span class="symbol-label" style="background-image:url('{{asset("public/storage/" . $order->image)}}');"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{ $order->name }}</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{ $order->sku }}</span>
                        </td>
                        <td class="text-end pe-0" data-order="39">
                            <span class="fw-bold ms-3">{{ $order->shelf_qty ?? 0 }}</span>
                        </td>
                        <td class="text-end pe-0">K {{ $order->price }}</td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    {{-- <a href="{{ route('Sale.edit', $order->id) }}" class="menu-link px-3">Edit</a> --}}
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    ...
                                    <form id="delete-product-form-{{ $order->id }}" action="{{ route('product.destroy', $order->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
