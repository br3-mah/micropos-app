...
<div id="kt_app_content_container" class="app-container container-xxl">
    <div class="page-title d-flex flex-column me-5 py-2">
        <!--begin::Title-->
        <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Delivery History</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-muted">My Delivery</li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-200 w-5px h-2px"></span>
            </li>
            <li class="breadcrumb-item text-dark">Delivery History</li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    <!--begin::Products-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-end min-w-100px">Delivery Method</th>
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-0">
                            <span class="fw-bold">{{ $delivery->sku }}</span>
                        </td>
                        <td class="text-end pe-0" data-order="39">
                            <span class="fw-bold ms-3">{{ $delivery->shelf_qty ?? 0 }}</span>
                        </td>
