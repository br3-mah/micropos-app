                                ...
                                <div class="sc_extended_products sc_extended_products_info_2">
                                    <div style="display: flex" class="sc_extended_products_content sc_item_content">
                                        ...
                                        <div style="width: 80%; margin-top:2%">
                                            <div class="woocommerce columns-3 hide-on-mobile">
                                                    <div class="active" style="width:100%">
                                                        <h5 style="text-align:center;"><strong style="color: rgb(50, 79, 46)">Featured</strong> <span style="color: #871f1a">Products</span></h5>
                                                        <div style="text-align:center;" class="cache">Trending</div>
                                                    </div>                                                
                                            ...
                                            <div class="woocommerce columns-3 hide-on-mobile">
                                                <div class="active" style="width:100%">
                                                    <h5 style="text-align:center;"><strong style="color: rgb(50, 79, 46)">Recommended</strong> <span style="color: #871f1a">for you</span></h5>
                                                    <div style="text-align:center;" class="cache">Best Agriculture Products</div>
                                                </div> 
                                                <ul class="products products_style_info_2 columns-4">
                                                    @forelse ($products as $product)
                                                    <li class="product type-product post-{{ $product->id }} status-publish first instock product_cat-berries product_cat-fruits product_cat-organic product_tag-crop product_tag-organic product_tag-season product_tag-summer has-post-thumbnail shipping-taxable purchasable product-type-simple product_style_info_2">
