       ...
       <div class="lg:col-span-1">
        <div class="grid grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
         ...
         <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
          <img alt="" class="w-7 mt-4 ms-5" src="{{ env('APP_URL') }}/public/assets/img/companies.png"/>
         ...
         <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
          <img alt="" class="w-7 mt-4 ms-5" src="{{ env('APP_URL') }}/public/assets/img/staff.png"/>
          <div class="flex flex-col gap-1 pb-4 px-5">
           <span class="text-3xl font-semibold text-gray-900">
            0
           </span>
         ...
         <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
          <img alt="" class="w-7 mt-4 ms-5" src="{{ env('APP_URL') }}/public/assets/img/pen.png"/>
          <div class="flex flex-col gap-1 pb-4 px-5">
           <span class="text-3xl font-semibold text-gray-900">
            0
           </span>
         ...
         <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
          <img alt="" class="dark:hidden w-7 mt-4 ms-5" src="{{ env('APP_URL') }}/public/assets/img/return.png"/>
          {{-- <img alt="" class="light:hidden w-7 mt-4 ms-5" src="{{ env('APP_URL') }}/public/assets/media/brand-logos/tiktok-dark.svg"/> --}}
          <div class="flex flex-col gap-1 pb-4 px-5">
           <span class="text-3xl font-semibold text-gray-900">
            0
           </span>
         ...
         <div class="card-body p-10 bg-[length:80%] [background-position:175%_25%] bg-no-repeat entry-callout-bg">
          <div class="flex flex-col justify-center gap-4">
           <div class="flex -space-x-2">
            <div class="flex">
             <img width="200" class="hover:z-5 relative shrink-0 ring-1 ring-light-light" src="{{ env('APP_URL') }}/public/assets/img/smart.webp"/>
            </div>
            {{-- <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-1.png"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-2.png"/>
            </div>
            <div class="flex">
        ...
        <div class="card h-full">
         <div class="card-body lg:p-7.5 lg:pt-6 p-5">
          <div class="flex items-center justify-between flex-wrap gap-5 mb-7.5">
           ...
           <img alt="" class="size-7" src="{{ env('APP_URL') }}/public/assets/media/brand-logos/zoom.svg"/>
          </div>
          ...
          <div class="flex rounded-lg bg-gray-100 gap-10 p-5">
           ...
           <div class="flex flex-col gap-5">
            ...
            <div class="flex -space-x-2">
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/img/smart.webp"/>
             </div>
             {{--<div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-1.png"/>
             </div>
              <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-2.png"/>
             </div>
             <div class="flex">
              ...
              <tbody>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-4.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-1.png"/>
                  </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-24.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-7.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-3.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-8.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-9.png"/>
                  </div>
                  <div class="flex">
               ...
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-6.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-5.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-10.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-11.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-12.png"/>
                  </div>
                  <div class="flex">
               ...
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-13.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-14.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-15.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-16.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-17.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-18.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-19.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-20.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-21.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-22.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-23.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  ...
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-25.png"/>
                  </div>
                 </div>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-26.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-27.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-28.png"/>
                  </div>
                  <div class="flex">
                   <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-3xs size-[30px] text-info-inverse ring-info-light bg-info">
                    +3
               ...
               <tr>
                ...
                <td>
                 <div class="flex -space-x-2">
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-29.png"/>
                  </div>
                  <div class="flex">
                   <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ env('APP_URL') }}/public/assets/media/avatars/300-30.png"/>
                  </div>
                 </div>
                </td>
               </tr>
