                ...
                new Dropzone("#kt_ecommerce_add_product_media", {
                    ...
                    init: function() {
                        this.on("addedfile", function(file) {
                            // You can add the name attribute here
                            var nameInput = document.getElementById("multiplexfiles");
                            nameInput.setAttribute("type", "file");
                            nameInput.setAttribute("name", "xproduct_images[]"); // Change the name attribute as needed
                            nameInput.setAttribute("value", JSON.stringify(file));
